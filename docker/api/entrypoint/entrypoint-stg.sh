...
php artisan --env=stg config:clear
php artisan --env=stg queue:restart
php artisan --env=stg migrate
php artisan --env=stg db:seed
# php artisan --env=stg serve --port=3000 --host 0.0.0.0
